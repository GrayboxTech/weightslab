...
class DataService:
    ...
    def _get_loader_by_origin(self, origin: str):
        ...
        try:
            ...
            loaders = []
            if origin is None:
                loaders = [self._ctx.components.get(loader_name) for loader_name in loader_names]
                return loaders
            # Check each loader for a matching tracked dataset origin or fallback to name matching
        ...
        return loaders if loaders else None
