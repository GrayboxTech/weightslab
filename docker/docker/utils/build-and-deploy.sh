...
for arg in "$@"; do
  case "$arg" in
    ...
    --unsecure|--unsecured)
      ...
      FORCE_UNSECURE=1
      ;;
    ENABLE_PLOTS=*)                        ENABLE_PLOTS="${arg#*=}" ;;
    ENABLE_DATA_EXPLORATION=*)             ENABLE_DATA_EXPLORATION="${arg#*=}" ;;
    ENABLE_HYPERPARAMETERS_OPTIMIZATION=*) ENABLE_HYPERPARAMETERS_OPTIMIZATION="${arg#*=}" ;;
    ENABLE_AGENT=*)                        ENABLE_AGENT="${arg#*=}" ;;
    BB_THUMB_RENDER=*)                     BB_THUMB_RENDER="${arg#*=}" ;;
    BB_MODAL_RENDER=*)                     BB_MODAL_RENDER="${arg#*=}" ;;
    WS_HISTOGRAM_MAX_BINS=*)               WS_HISTOGRAM_MAX_BINS="${arg#*=}" ;;
    GRID_WINDOW_SIZE=*)                    GRID_WINDOW_SIZE="${arg#*=}" ;;
    GRID_CACHE_MAX_MB=*)                   GRID_CACHE_MAX_MB="${arg#*=}" ;;
    MODAL_CACHE_MAX_MB=*)                  MODAL_CACHE_MAX_MB="${arg#*=}" ;;
    PC_MAX_POINTS=*)                       PC_MAX_POINTS="${arg#*=}" ;;
    DISABLE_GPU_RENDERING=*)               DISABLE_GPU_RENDERING="${arg#*=}" ;;
  esac
done
...
echo "Looking at Weightslab Certs dir directory at: ${TOKEN_FILE}"
...
BB_THUMB_RENDER=${BB_THUMB_RENDER:-10}
BB_MODAL_RENDER=${BB_MODAL_RENDER:-100}
WS_HISTOGRAM_MAX_BINS=${WS_HISTOGRAM_MAX_BINS:-512}
VITE_HISTOGRAM_MAX_BINS=${WS_HISTOGRAM_MAX_BINS:-512}
GRID_WINDOW_SIZE=${GRID_WINDOW_SIZE:-6}
VITE_GRID_WINDOW_SIZE=${GRID_WINDOW_SIZE:-6}
GRID_CACHE_MAX_MB=${GRID_CACHE_MAX_MB:-128}
VITE_WS_GRID_CACHE_MAX_MB=${GRID_CACHE_MAX_MB:-128}
MODAL_CACHE_MAX_MB=${MODAL_CACHE_MAX_MB:-64}
VITE_WS_MODAL_CACHE_MAX_MB=${MODAL_CACHE_MAX_MB:-64}
PC_MAX_POINTS=${PC_MAX_POINTS:-}
VITE_WL_PC_MAX_POINTS=${PC_MAX_POINTS:-}
DISABLE_GPU_RENDERING=${DISABLE_GPU_RENDERING:-0}
VITE_WL_DISABLE_GPU_RENDERING=${DISABLE_GPU_RENDERING:-0}
ENABLE_PLOTS=${ENABLE_PLOTS:-1}
ENABLE_DATA_EXPLORATION=${ENABLE_DATA_EXPLORATION:-1}
ENABLE_HYPERPARAMETERS_OPTIMIZATION=${ENABLE_HYPERPARAMETERS_OPTIMIZATION:-1}
