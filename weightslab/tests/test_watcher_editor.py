...
def create_inference_test(ModelClass):
    ...
    def model_test(self):
        ...
        dummy_input = torch.randn(model.input_shape).to(DEVICE)
        ...
        initial_nb_trainable_parameters = get_nb_parameters_neuronwise(model)
        ...
        nb_trainable_parameters = get_nb_parameters_neuronwise(model)
        self.assertGreater(
        ...
        self.assertIn(
            ...
            range(initial_nb_trainable_parameters, initial_nb_trainable_parameters-20, -1),
        ...
        # TODO (GP): Resolve why unmasked parameters are not fully restored
        # TODO (GP): (612!=611) for modelclass GraphMLP_Res_Test_A.
