...
class NetworkWithOps(nn.Module):
    ...
    def load_state_dict(
        ...
        # Pop legacy tracking attributes if they exist
        state_dict.pop('seen_samples', None)
        state_dict.pop('model.seen_samples', None)
        state_dict.pop('model.current_step', None)
